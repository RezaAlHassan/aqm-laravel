...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
        ...
        <span class="ms-3 font-weight-bold">AQM Dashboard</span>
    </a>
  </div>
  ...
  <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item mt-2">
        <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Panel</h6>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('chart-tables') ? 'active' : '') }}" href="{{ url('chart-tables') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <span class="nav-link-text ms-1">Chart Tables</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('stationwise-table') ? 'active' : '') }}" href="{{ url('stationwise-table') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <span class="nav-link-text ms-1">Stationwise Table</span>
        </a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('rtl') ? 'active' : '') }}" href="{{ url('rtl') }}">
          ...
          <span class="nav-link-text ms-1">Routewise Table</span>
        </a>
      </li>
