<!-- Navbar -->
<nav class="navbar navbar-expand-sm position-absolute top-0 z-index-3 my-5 {{ (Request::is('static-sign-up') ? 'w-100 shadow-none  navbar-transparent mt-4' : 'blur blur-rounded shadow py-2 start-0 end-13 mx2') }}">
