                    ...
                    @endif
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div >
                                    <input class="form-control" id="validation1"  placeholder="Ex: Dhaka" name="district" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div >
                                    <input class="form-control" id="validation2"  type="number" placeholder="Number"  name="station" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div >
                                    <input class="form-control" id="validation3" type="number" placeholder="Value"  name="pm" step="0.01" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div >
                                    <input class="form-control" id="validation4" type="number" placeholder="Value" name="aqi" step="0.01" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div >
                                    <input class="form-control" id="validation5"  placeholder="Name" name="organization" required>
                                        @error('organization')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div >
                                    <input class="form-control" id="validation6"  placeholder="Ex: Summer"  name="season" required>
